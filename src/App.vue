<template>
  <div id="app">
      <!-- Header -->
        ...
        <!-- This is JUST the navbar footer, which includes all the contact symbols at the bottom of the turquoise: -->
				<footer>
					<ul class="icons">
            <!-- I'd love to add a section for my Medium & LinkedIn. How do I do that? -->
						<!-- <li><a href="#" class="icon brands fa-twitter"><span class="label">Twitter</span></a></li>
						<li><a href="#" class="icon brands fa-facebook-f"><span class="label">Facebook</span></a></li> -->
						<!-- <li><a href="#" class="icon brands fa-instagram"><span class="label">Instagram</span></a></li> -->
						<li><a href="https://github.com/jldelorimier0" class="icon brands fa-github"><span class="label">Github</span></a></li>
						<li><a href="jldelorimier@gmail.com" class="icon solid fa-envelope"><span class="label">Email</span></a></li>
					</ul>
				</footer>
			</section>
    ...
    <!-- Wrapper -->
			<div id="wrapper"> 
				...
				<!-- Main -->
					<div id="main">
						...
						<!-- One -->
							<!-- <section id="one">
								...
								<div class="container">
									<header class="major">
										<h2>This is my favorite section</h2>
							...
							<!-- <section id="two">
								<div class="container">
									...
									<ul class="feature-icons">
										<li class="icon solid fa-code">Monthly Spending</li>
										<li class="icon solid fa-cubes">Flight Spending</li>
										<li class="icon solid fa-book">Hotel Spending</li>
										<li class="icon solid fa-coffee">If you can move your spending to this card</li>
										<li class="icon solid fa-bolt">Global Entry/TSA pre-check</li>
                  ...
                  <section>
                    <router-view/>
                        ...
                        <!-- original copy of radio buttons -->
                          <!-- left third radio -->
												<!-- <div class="col-4 col-12-medium">
													<input type="radio" id="demo-priority-low" name="demo-priority" checked>
													<label for="demo-priority-low">Yes</label>
				...
				<!-- Footer -->
        <!-- I think this is just the gray footer -->
					<section id="footer">
						<div class="container">
							<ul class="copyright">
